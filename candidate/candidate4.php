  ...
  <body>
    <div class="header">
       ...
       <span id="btn_login_group">
        ...
        <div class="nav">
          <span class="nav_item"><a id="nav_item_home" href="#">행정</a></span>
   ...
   <script>
       ...
       $(document).ready(function(){
         ...
         $.get(url, {candidate:'행정'}, function(args){
